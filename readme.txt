...
4. Place \"[CATGAL cat_id=category id];\" in your post. (You can automatically generate shortcode by using the shortcode generator, which can be found under category-gallery in settings menu.)

== Screenshots ==
1. In-theme visual
2. Toogle Media Category
3. Admin panel visual
4. Admin panel shortcode generator
